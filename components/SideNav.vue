    ...
    <ul class="menu flex flex-col  items-center justify-evenly h-[100%]  font-bold !w-[100%]">
      ...
      >
        <div>
          <NuxtLink
            :to="item.route || ''"
            class="flex justify-center flex-col items-center hover:bg-[#d9d9d921] w-[100%]"
            :class="{ 'bg-[#d9d9d921]': isActive(item.route) }"
          >
            <img class="w-5" :src="item.icon" alt="" />
...
const menuItems = ref([
  ...
  children: [
        ...
        { title: "المعمل 3", route: "/labSection/lab3" },
        { title: "المعمل 4", route: "/labSection/lab4" },
    ],
   },
  { title: " المخازن", route: null, icon: Package ,
  children: [
      { title: "مخزن قطع غيار", route: null,
      children: [
...
const menuDropdownItems = ref([
  { title: " المحاسبه", route: null, icon: Calculator },
  { title: " المشتريات", route: null, icon: DollarCoin },
  { title: " المبيعات", route: null, icon: TotalSales },
  { title: " الموارد البشريه", route: null, icon: UserGroups },
  { title: " التعبئه", route: null, icon: MineCart ,
  children: [
        { title: "انشاء تقرير", route: "/warhouses/packagingAndTotalStores/createReport" },
        { title: "سجلات التقارير", route: "/warhouses/packagingAndTotalStores/reportRecords" },
    ],
  },  
  { title: " التحميل", route: null, icon: Shipped ,
  children: [
